...
?>
<table style="max-width:580px; width:100%; background: #f3f3f3;" border="0" cellspacing="0" cellpadding="0" align="center">
  <tbody>
    <tr>
      <td><img src="<?php echo $base_url."/".$themePath;?>/images/template-header.jpg" alt="" /></td>
    </tr>
    <tr>
      <td><?php echo $body; ?></td>
    </tr>
    <tr>
      <td style="background-color:#000;padding:0px 20px 0px;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#fff;text-align:left;vertical-align:middle;height:41px">&copy; Where its at <?php echo date('Y');?>. All Rights Reserved</td>
    </tr>
  </tbody>
</table>